...
const routes = [
  ...
  },
  {
    ...
    meta: {
      layout: "auth",
      guest: true,
      title: "Ro'yxatdan o'tish · FindTheWay Biznes",
    },
  },
  {
    path: "/auth-bridge",
    name: "auth-bridge",
    component: () => import("../views/AuthBridgeView.vue"),
    meta: { layout: "blank", title: "Sessiya · FindTheWay Biznes" },
  },
  {
    path: "/",
    name: "dashboard",
  ...
  },
  {
    ...
    meta: {
      layout: "dashboard",
      requiresOwner: true,
      title: "To'lov · FindTheWay Biznes",
    },
  },
  {
    path: "/:pathMatch(.*)*",
